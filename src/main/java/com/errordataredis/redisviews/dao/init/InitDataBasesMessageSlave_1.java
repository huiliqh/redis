...
@Component
@Order(99)
@DS(DataSourceStatus.SLAVE_1)
@DependsOn(value = {"initDataBasesMessageMaster"})
public class InitDataBasesMessageSlave_1 implements CommandLineRunner {
   ...
   private Power power;
    public String dataInformationRestart(){
        try {
            DataSourceStatus.statusMessage = DataSourceStatus.BOOSTER_STATION;//更改服务层的检索状态
            init();
        } catch (Exception e) {
    ...
    private void init(){
        try {
            System.out.println("DATABASESMESSAGE 数据信息初始化中...数据源_slave_1");
            ...
            System.out.println("DATABASEMESSAGE 数据信息初始化完毕...数据源_slave_1");
    ...
    public void run(String... args) throws Exception {
        System.out.println("数据源slave_1——容器就绪完毕___");
    }
}
